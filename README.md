...
- ⚙ 200+ проектов на BAS
- 🧠 10 месяцев на проде (CyberOk)
- 🐙 6 open-source тулзов
...
- Разработка и сопровождение модулей сетевых сканеров **zgrab3** и **httpx**
...
- Фиксы баннеров, favicons, TLS-логики, SHA256, HTTP/redirect багов, panic-crash, etc... → более 50 мерджей, продакшн-уровень
